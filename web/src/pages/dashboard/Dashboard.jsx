      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-start justify-start w-auto">
            ...
            <h4 className="text-[24px] font-semibold">Overview</h4>
          </div>
        </div>
        <div className="flex gap-6">
          <Select>
            ...
            <SelectContent>
              ...
              <SelectItem value="Java House">Java House</SelectItem>
              <SelectItem value="Kenya Airways">Kenya Airways</SelectItem>
              <SelectItem value="Nairobi Hospital	">
                Nairobi Hospital{" "}
              </SelectItem>
            </SelectContent>
          </Select>
